...
define('DB_DATABASE', 'test_users'); //make sure to set your database
...
// always remember the variable must be declare first before the assostiate array look for the example below
